...
plt.show()
plt.savefig("media/channel_performance.png")
...
plt.ylabel('Number of Customers')
plt.show()
plt.savefig("media/rfm_score_distribution.png")
...
plt.xticks(rotation=45)
plt.show()
plt.savefig("media/segment_distribution.png")
...
plt.show()
plt.savefig("media/correlation_matrix.png")
...
plt.show()
plt.savefig("media/customer_behavior_analysis.png")


# Clustering Results
# RFM Segmentasyon Analizi
plt.figure(figsize=(12, 8))
...
plt.legend(title='Segment')
plt.show()
plt.savefig("media/rfm_segmentation_results.png")
